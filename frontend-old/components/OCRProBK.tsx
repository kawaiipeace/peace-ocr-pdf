...
// Docxtemplater for generating DOCX
...
export default function Home() {
  ...
  const exportToWord = () => {
    ...
    zip.file(
      "_rels/.rels",
      '<?xml version="1.0" encoding="UTF-8"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="word/document.xml" TargetMode="Internal"/></Relationships>',
    );
  ...
  return (
    <div>
      ...
      <input accept=".pdf,image/*" type="file" onChange={handleFileChange} />
              ...
              >
                ...
                <div>
                  ...
                  <img
                    ...
                    src={pages[currentPage - 1].toDataURL()}
                  />
                </div>
              </div>
            </div>
